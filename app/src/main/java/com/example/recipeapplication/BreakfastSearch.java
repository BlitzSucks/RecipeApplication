        ...
        databaseRecipes.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren())
                {
                    ...
                    if(recipe.getRecipeType().equals("Breakfast"))
                    {
                ...
                //creating adapter
                BreakfastRefer recipeAdapter = new BreakfastRefer(BreakfastSearch.this, recipes);

                //attaching adapter to the list view
                ListView BreakfastListview = findViewById(R.id.breakfastListview);
                BreakfastListview.setAdapter(recipeAdapter);
            }
