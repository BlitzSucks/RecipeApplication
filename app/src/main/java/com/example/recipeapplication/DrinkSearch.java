...
public class DrinkSearch extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.searchdrink);
        ...
        databaseRecipes.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren())
                {
                    ...
                    if(recipe.getRecipeType().equals("Drink"))
                    {
                ...
                //creating adapter
                DrinkRefer recipeAdapter = new DrinkRefer(DrinkSearch.this, recipes);

                //attaching adapter to the list view
                ListView DrinkListview = findViewById(R.id.drinkListview);
                DrinkListview.setAdapter(recipeAdapter);
            }
