        ...
        databaseRecipes.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren())
                {
                    ...
                    if(recipe.getRecipeType().equals("Lunch"))
                    {
                ...
                //creating adapter
                LunchRefer recipeAdapter = new LunchRefer(LunchSearch.this, recipes);

                //attaching adapter to the list view
                ListView LunchListview = findViewById(R.id.lunchListview);
                LunchListview.setAdapter(recipeAdapter);
            }
